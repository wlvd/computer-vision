...
Utilizare:
    python3 complete_pipeline_tRT_media_3.py sample_vid.mp4
    python3 complete_pipeline_tRT_media_3.py sample_vid.mp4        # a doua oara: recunoaste
    python3 complete_pipeline_tRT_media_3.py sample/sample_vid.mp4 --database baza.json
    python3 complete_pipeline_tRT_media_3.py sample_vid.mp4 --reset-db --overwrite
...
def probe_video_info(video_path, timeout_s=10):
    ...
    Se cere Gst.init() inainte. GstPbutils e prima varianta pentru ca vede si
    eticheta de rotatie; OpenCV e plasa de siguranta daca typelib-ul lipseste.
    """
    try:
