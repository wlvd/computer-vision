...
cooldown, the same identity continuity and the same automatic enrollment.

Two redundancies that _17 still carried are gone here, both without changing a single
...
What is gone compared with _15 is the tuning scaffolding, which had nothing to do with
recognising a face:
