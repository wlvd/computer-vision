...
Utilizare:
    python3 complete_pipeline_tRT_media_11.py sample_vid.mp4
    python3 complete_pipeline_tRT_media_11.py sample_vid.mp4       # a doua oara: recunoaste
    python3 complete_pipeline_tRT_media_11.py sample/sample_vid.mp4 --database baza.json
    python3 complete_pipeline_tRT_media_11.py sample_vid.mp4 --reset-db --overwrite
